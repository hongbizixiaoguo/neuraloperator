...
from neuralop.models.simple_adaptive_fno import SimpleAdaptiveFNO2d
...
def quick_training_test():
    ...
    plt.tight_layout()
    plt.savefig('/root/autodl-tmp/neuraloperator/simple_adaptive_fno_test.png')
    plt.show()
...
def main():
    ...
    """
    print("="*50)
    print("Simple Adaptive FNO Test Suite")
    print("="*50)
    ...
    print("Simple Adaptive FNO is working correctly.")
    print("="*50)
